...
// DiscoveryEnabledResponse returns whether discovery is enabled for the plugin.
type DiscoveryEnabledResponse struct {
	IsDiscoveryEnabled   bool     `protobuf:"varint,1,opt,name=isDiscoveryEnabled,proto3" json:"isDiscoveryEnabled,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}

func (m *DiscoveryEnabledResponse) Reset()         { *m = DiscoveryEnabledResponse{} }
func (m *DiscoveryEnabledResponse) String() string { return proto.CompactTextString(m) }
func (*DiscoveryEnabledResponse) ProtoMessage()    {}
func (*DiscoveryEnabledResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_b21875a7079a06ed, []int{6}
}
func (m *DiscoveryEnabledResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *DiscoveryEnabledResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_DiscoveryEnabledResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *DiscoveryEnabledResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_DiscoveryEnabledResponse.Merge(m, src)
}
func (m *DiscoveryEnabledResponse) XXX_Size() int {
	return m.Size()
}
func (m *DiscoveryEnabledResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_DiscoveryEnabledResponse.DiscardUnknown(m)
}

var xxx_messageInfo_DiscoveryEnabledResponse proto.InternalMessageInfo

func (m *DiscoveryEnabledResponse) GetIsDiscoveryEnabled() bool {
	if m != nil {
		return m.IsDiscoveryEnabled
	}
	return false
...
// DiscoveryEnabledResponse returns whether discovery is enabled for the plugin.
type DiscoveryEnabledRequest struct {
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}

func (m *DiscoveryEnabledRequest) Reset()         { *m = DiscoveryEnabledRequest{} }
func (m *DiscoveryEnabledRequest) String() string { return proto.CompactTextString(m) }
func (*DiscoveryEnabledRequest) ProtoMessage()    {}
func (*DiscoveryEnabledRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_b21875a7079a06ed, []int{7}
}
func (m *DiscoveryEnabledRequest) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *DiscoveryEnabledRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_DiscoveryEnabledRequest.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *DiscoveryEnabledRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_DiscoveryEnabledRequest.Merge(m, src)
}
func (m *DiscoveryEnabledRequest) XXX_Size() int {
	return m.Size()
}
func (m *DiscoveryEnabledRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_DiscoveryEnabledRequest.DiscardUnknown(m)
}

var xxx_messageInfo_DiscoveryEnabledRequest proto.InternalMessageInfo
...
func init() {
	...
	proto.RegisterType((*DiscoveryEnabledResponse)(nil), "plugin.DiscoveryEnabledResponse")
	proto.RegisterType((*DiscoveryEnabledRequest)(nil), "plugin.DiscoveryEnabledRequest")
...
var fileDescriptor_b21875a7079a06ed = []byte{
	...
	,
}
...
type ConfigManagementPluginServiceClient interface {
	...
	// GetDiscoveryEnabled returns whether discovery is enabled for the plugin
	GetDiscoveryEnabled(ctx context.Context, in *DiscoveryEnabledRequest, opts ...grpc.CallOption) (*DiscoveryEnabledResponse, error)
}
...
func (c *configManagementPluginServiceClient) GetDiscoveryEnabled(ctx context.Context, in *DiscoveryEnabledRequest, opts ...grpc.CallOption) (*DiscoveryEnabledResponse, error) {
	out := new(DiscoveryEnabledResponse)
	err := c.cc.Invoke(ctx, "/plugin.ConfigManagementPluginService/GetDiscoveryEnabled", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ConfigManagementPluginServiceServer interface {
	...
	// GetDiscoveryEnabled returns whether discovery is enabled for the plugin
	GetDiscoveryEnabled(context.Context, *DiscoveryEnabledRequest) (*DiscoveryEnabledResponse, error)
}
...
func (*UnimplementedConfigManagementPluginServiceServer) GetDiscoveryEnabled(ctx context.Context, req *DiscoveryEnabledRequest) (*DiscoveryEnabledResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetDiscoveryEnabled not implemented")
}
...
func _ConfigManagementPluginService_GetDiscoveryEnabled_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(DiscoveryEnabledRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ConfigManagementPluginServiceServer).GetDiscoveryEnabled(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/plugin.ConfigManagementPluginService/GetDiscoveryEnabled",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ConfigManagementPluginServiceServer).GetDiscoveryEnabled(ctx, req.(*DiscoveryEnabledRequest))
	}
...
var _ConfigManagementPluginService_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "GetDiscoveryEnabled",
			Handler:    _ConfigManagementPluginService_GetDiscoveryEnabled_Handler,
		},
	},
...
func (m *DiscoveryEnabledResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *DiscoveryEnabledResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *DiscoveryEnabledResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *DiscoveryEnabledRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *DiscoveryEnabledRequest) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *DiscoveryEnabledRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *DiscoveryEnabledResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *DiscoveryEnabledRequest) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *DiscoveryEnabledResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: DiscoveryEnabledResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: DiscoveryEnabledResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
...
func (m *DiscoveryEnabledRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: DiscoveryEnabledRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: DiscoveryEnabledRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		default:
			iNdEx = preIndex
